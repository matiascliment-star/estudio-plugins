...
# desde la ubicación de este script. Esto evita depender del symlink en
# ~/.claude/plugins/marketplaces/ (ruta sensitive en CCR remote sandboxes que
# pide permiso aunque esté en el allowlist) y funciona igual local que remoto.
